...
function evaluate(ξ::Float64,η::Float64)
    ...
    dphi_dη[ 1]=(128*η^3)/3+128*η^2*ξ-80*η^2+128*η*ξ^2-160*η*ξ+(140*η)/3+(128*ξ^3)/3-80*ξ^2+(140*ξ)/3-25/3;
    dphi_dη[ 2]=0;
    dphi_dη[ 3]=(128*η^3)/3-48*η^2+(44*η)/3-1;
    dphi_dη[ 4]=-(16*ξ*(24*η^2+48*η*ξ-36*η+24*ξ^2-36*ξ+13))/3;
    dphi_dη[ 5]=4*ξ*(4*ξ-1)*(8*η+8*ξ-7);
    dphi_dη[ 6]=-(8*ξ*(4*ξ-1)*(4*ξ-2))/3;
    dphi_dη[ 7]=(8*ξ*(4*ξ-1)*(4*ξ-2))/3;
    dphi_dη[ 8]=4*ξ*(8*η-1)*(4*ξ-1);
    dphi_dη[ 9]=(16*ξ*(24*η^2-12*η+1))/3;
    dphi_dη[10]=64*η*ξ-(16*ξ)/3-(224*η)/3-128*η^2*ξ+224*η^2-(512*η^3)/3+16/3;
    dphi_dη[11]=256*η^3+384*η^2*ξ-384*η^2+128*η*ξ^2-288*η*ξ+152*η-16*ξ^2+28*ξ-12;
    dphi_dη[12]=-(512*η^3)/3-384*η^2*ξ+288*η^2-256*η*ξ^2+384*η*ξ-(416*η)/3-(128*ξ^3)/3+96*ξ^2-(208*ξ)/3+16;
    dphi_dη[13]=32*ξ*(12*η^2+16*η*ξ-14*η+4*ξ^2-7*ξ+3);
    dphi_dη[14]=-32*ξ*(4*ξ-1)*(2*η+ξ-1);
    dphi_dη[15]=-32*ξ*(8*η*ξ-ξ-10*η+12*η^2+1);
